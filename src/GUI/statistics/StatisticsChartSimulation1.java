 ...
 */
public class StatisticsChartSimulation1 extends StatisticsChartSolver {

    public StatisticsChartSimulation1(EAsolver solver) {
        super(solver);
    }
...
//         set the renderer's stroke
    ...
    public static void main(String[] args) {
        ...
        StatisticsChartSolver demo = new StatisticsChartSimulation1(solver);
