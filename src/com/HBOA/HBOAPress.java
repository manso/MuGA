...
public class HBOAPress{
	...
	public static void printInitialInfo(){
		String str = "############ - HBOA - ############ - HBOA - ############ - HBOA - ############" + 
					 "\n#" +
					 "\n#   HBOA:" +
					 "\n#     ->   Number of Runs = " + HBOA_original.nRuns                 +
	...
	public static void printRunInitialInfo(int r){
		printString("\n##### START RUN " + (r+1) + "/" + HBOA_original.nRuns + " #####" + 
			 	      "##### START RUN " + (r+1) + "/" + HBOA_original.nRuns + " #####" +
			 	      "##### START RUN " + (r+1) + "/" + HBOA_original.nRuns + " #####\n\n" +
	...
	public static void printRunFinalInfo(int r){
		String str = "\n############################################################################" +
					 ...
					 "\n#  Current Success Rate: " + HBOA_original.nSuccess + "/" + (r+1) +					 
					 "\n# Current Fitness Calls: " + HBOASolver.fitCalls         +
					 "\n#"                                                       +
					 "\n######## END RUN " + (r+1) + "/" + HBOA_original.nRuns + " #####"    + 
					      "##### END RUN " + (r+1) + "/" + HBOA_original.nRuns + " #####"    +
					      "##### END RUN " + (r+1) + "/" + HBOA_original.nRuns + " ########\n\n\n";
		printString(str);
	}
	...
	public static void printFinalInfo(){
		printString("\nSUCCESS RATE = " + HBOA_original.nSuccess + "/" + HBOA_original.nRuns + "\n");
		closeTestFiles();
	}
