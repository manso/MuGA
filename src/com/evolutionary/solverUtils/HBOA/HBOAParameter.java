...
import com.evolutionary.solverUtils.HBOA.metric.BICMetric;
...
public class HBOAParameter{
	...
	// Selector parameters
	private static float pNS;				// Size of selectHB set as a proportion of N. Default = 1 (The same value as N)
	private static int   NS;				// Size of the selectHB set. Depends on the chosen selectHB method.
	private static int   selectionMethod;	// HBOASelection method. Default = 1 (Tournament selectHB)
	private static int   tourSize;			// Size of tournament. Use only with Tournament HBOASelection (selectHB = 1 or 2)
	...
	private static int replacementType;		// Replacement method. Default = 1 (Restricted replacementHB)
	private static int windowSize;			// Size of replacementHB tournament. Use only with RestrictedReplacement (replacementHB = 2)
	...
	public static HBOASelection initializeSelection(int N){
