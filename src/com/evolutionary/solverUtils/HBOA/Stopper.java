...
public class Stopper{
	...
	public static int   maxNGen;			// Maximal number of generations to perform. 			 Default = 200
	...
	private static boolean fitnessCalls(){return (maxFitCalls == -1)? false: HBOASolver.fitCalls >= maxFitCalls;}
