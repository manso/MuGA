...
abstract class HBOASelection{
	public int NS;										// HBOASelection Set size. NOTE: This is initialized and refreshed by Parameter.
	
	public HBOASelection(){}								// Default empty constructor.
	public int getNS(){return NS;}
	abstract SelectedSet select(Population population);
}

class TourWithReplacement extends HBOASelection{
...
class TourWithoutReplacement extends HBOASelection{
...
class Truncation extends HBOASelection{
