 ...
 */
public class DecimationDiversity extends Replacement {
        ...
        while (parents.getSize() > parents.maximumSize) {
            ...
            for (int i = 1; i < tourSize; i++) {
                ...
                if (compare > 0) {
                    indexWorst = index2;
                    worst = probe;
                } else if (compare == 0 && probe.getNumberOfCopies() < worst.getNumberOfCopies()) { // get smal number o copies
                    indexWorst = index2;
                    worst = probe;
                }
            }
...
//        for (int k = 0; k < 100; k++) {
        ...
        Replacement t = new DecimationDiversity();
