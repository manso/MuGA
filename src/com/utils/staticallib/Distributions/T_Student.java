...
public class T_Student
  { 
     ...
     *  DESCRIPTION
     *
     *    The density of the "Student" T_Student distribution.
     */
...
/*!* 	/ (sqrt(n) * beta(0.5, 0.5 * n)); *!*/
     ...
     *  DESCRIPTION
     *
     *    The "Student" T_Student distribution quantile function.
     *
     *  NOTES
     *
     *    This is a C translation of the Fortran routine given in:
     *    Algorithm 396: Student's T_Student-quantiles by G.W. Hill
...
/*!* 	return Normal.random!!!COMMENT!!!() / sqrt(rchisq(df) / df); *!*/
    ...
    public static double twoTailed(double alpha, double nf){
        alpha = alpha + (1.0 - alpha)/2.0;
        return T_Student.quantile(alpha, nf);
    }
    
    public static double oneTailed(double alpha, double nf){
        return T_Student.quantile(alpha, nf);
    }
    ...
    public static void main(String[] args) {
        double alpha = 0.95;
        for (int i = 1; i < 100; i++) {
//            System.out.println("one Tailed " + i + " \t" + T_Student.oneTailed(alpha, i));
            System.out.println("two Tailed " + i + " \t" + T_Student.twoTailed(alpha, i));
        }
    }
