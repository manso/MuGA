 ...
 * @author zulu
 */
public class M_CrossoverTest {

    static GeneticOperator opTemplate = new M_Crossover();
    ...
    public void CrossoverTest() {
        ...
        GeneticOperator x = opTemplate.getClone();
        x.setRandomGenerator(ind.random);
        //count ones
        int ones = countOnes(mp);
        int numind = mp.getNumberOfIndividuals();
        SimplePopulation pop2 = x.execute(mp);
...
//                    SimplePopulation p = pop .getClone(); // DEBUG DEBUG DEBUG DEBUG DEBUG
                    pop = op.execute(pop);
                    pop.evaluate();
                    int onesX = countOnes(pop);
                     if (ind != pop.getNumberOfIndividuals()) {
                        System.out.println(ind + " individuals  " + pop.getNumberOfIndividuals());
//                        pop = op.execute(p); // DEBUG DEBUG DEBUG DEBUG DEBUG  DEBUG DEBUG DEBUG DEBUG DEBUG
